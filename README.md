...
$ git clone https://github.com/jotape-SL/NavBar.git
...
- **[NavBar](https://nav-bar-phi.vercel.app/)**
...
Este projeto está sob a licença MIT - veja o arquivo [LICENSE.md](https://github.com/jotape-SL/NavBar/blob/main/LICENSE) para detalhes.
